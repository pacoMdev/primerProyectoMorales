...
<body>
    <nav class="bg-bs-color-0 navbar navbar-expand-lg bg-bs-color-0">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php"><img src="<?= (logo."_07827ff2-68a6-4dd1-acd3-4a346812c659-Photoroom.png"); ?>" alt="logo" height="50px" width="50px"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto gap-3 contenido-header border rounded-pill p-1">
                    <li class="nav-item">
                        <a class="nav-link text-center fs-6 rounded-pill" aria-current="page" href="">Menu</a>
                    </li>
                    <li class="nav-item">
