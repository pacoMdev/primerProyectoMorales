        ...
        <section class="row w-100 h-100 p-0 m-0 d-flex">
            <div class="col-md-3 col-lg-2 sidebar border-end">
                ...
                <div class="nav flex-column">
                    <a href="?controller=profile&action=show_history_order" class="nav-link px-4 py-3 tx-bs-color-3">
                        <span>
                    ...
                    <a href="?controller=profile&action=show_profile" class="nav-link active px-4 py-3 tx-bs-color-3">
                        <span><svg height="25px" width="25px" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path class="fll-bs-color-3" d="M29,17.6c-1.2-0.4-2-1-2-1.6s0.8-1.3,2-1.6c0.5-0.2,0.8-0.7,0.7-1.2c-0.4-1.8-1-3.4-2.1-4.9c-0.3-0.4-0.8-0.6-1.3-0.3
