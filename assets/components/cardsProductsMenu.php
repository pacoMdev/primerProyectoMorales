                            ...
                            <div class="container d-flex gap-5 align-content-center">
                                ...
                                <div class="container d-flex gap-2">
                                    ...
                                    if (true) {
                                        ...
                                        ?>
                                        <svg class="icono-header-medium border border-circle border-2" type="button"
                                            onclick="location.href='?controller=product&action=del_product&product_id=<?= $product_id ?>'"
                                            width="25px" height="25px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 12L18 12" class="icono-stroke-7" stroke-width="2" stroke-linecap="round"
